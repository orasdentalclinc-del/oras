...
قسم «آراء المرضى» في الموقع مكتمل ويعمل مع اللوحة كالتالي:

1. **الزائر** يضغط «أضف تقييمك» فيحدد نجوم (1–5)، ويكتب تعليقه، ويجيب على
   **استبيان من 5 أسئلة**.
2. **عند الإرسال** يصل التقييم كرسالة منسقة إلى واتساب العيادة (هذا هو الأنسب
   للمواقع الثابتة مثل GitHub Pages — لا يحتاج سيرفراً ولا يعرض أي مفاتيح سرية).
3. **أنت** تضيف التقييم من اللوحة: **⭐ آراء المرضى → New** ثم تلصق البيانات
   والإجابات، وتضع الحالة **«✅ معتمد»** وتضغط **Publish** — فيظهر فوراً على
   الموقع ويُحدَّث متوسط النجوم وعدد التقييمات تلقائياً.
...
> **ترقية اختيارية لاحقاً:** لجعل التقييمات تُسجَّل في Sanity تلقائياً بدون
> واتساب، يلزم وسيط من طرف السيرفر (مثل Cloudflare Worker أو Netlify Function
> يحمل توكن كتابة). تواصل مع المطور عند الحاجة — الواجهة جاهزة.
