 ...
 * تصل التقييمات الجديدة تلقائياً من الموقع (عبر review/Code.gs) بحالة «قيد المراجعة»،
 * ثم تعتمدها من هنا لتنشرها على الموقع.
 */
...
export default {
  ...
  fields: [
    ...
    {name: 'service', title: 'الخدمة (اختياري)', type: 'string', description: 'مثال: تبييض الأسنان'},
    {
      ...
      description: 'تصل تلقائياً من نموذج التقييم في الموقع (سؤال + درجة 1-5)',
      type: 'array',
      of: [
        {
          type: 'object',
