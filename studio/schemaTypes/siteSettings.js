...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        'تظهر هذه الروابط في أيقونات التواصل أسفل الموقع (فيسبوك، انستغرام، تيك توك). ملاحظة: واتساب يُدار من حقل «رقم واتساب»، والاتصال المباشر من حقل «رقم الهاتف» أعلاه.',
      type: 'array',
      of: [
        {
          type: 'object',
